...
Version  : 1.0.10
Release  : 41
URL      : https://cran.r-project.org/src/contrib/iterators_1.0.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/iterators_1.0.10.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552925466
